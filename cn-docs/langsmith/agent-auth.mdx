...
---
<Note>代理身份验证仅适用于 [LangSmith 云部署](/langsmith/deploy-to-cloud)。</Note>

<Note>代理身份验证处于 **Beta** 阶段，正在积极开发中。如需提供反馈或使用此功能，请联系 [LangChain 团队](https://forum.langchain.com/c/help/langsmith/)。</Note>
