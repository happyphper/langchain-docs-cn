...
>
    ...
    1.  从评论中复制预览分支的 ID。
    1.  在 [Mintlify 仪表板](https://dashboard.mintlify.com/langchain-5e9cc07a/langchain-5e9cc07a?section=previews)中，点击 **Create preview deployment**。
    1.  输入预览分支的 ID。
    1.  点击 **Create deployment**。
        **手动更新**将显示在 **Previews** 表中。
    1.  选择预览并点击 **Visit** 以查看预览构建。
