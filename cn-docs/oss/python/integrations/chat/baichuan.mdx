---
title: 与 Baichuan-192K 聊天
---
百川智能技术提供的百川（Baichuan）聊天模型 API。更多信息，请参阅 [https://platform.baichuan-ai.com/docs/api](https://platform.baichuan-ai.com/docs/api)
