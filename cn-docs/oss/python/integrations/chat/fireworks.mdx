...
title: ChatFireworks
---
本文档将帮助您开始使用 Fireworks AI 的[聊天模型](/oss/langchain/models)。如需了解 ChatFireworks 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/fireworks/chat_models/langchain_fireworks.chat_models.ChatFireworks.html)。
