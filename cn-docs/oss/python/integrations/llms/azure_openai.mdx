...
---
<Warning>
**您当前正在查阅的是关于 Azure OpenAI 文本补全模型的使用文档。最新且最受欢迎的 Azure OpenAI 模型是 [聊天补全模型](/oss/langchain/models)。**
...
_**注意**：本文档适用于 Azure 文本补全模型。像 GPT-4 这样的模型是聊天模型。它们的接口略有不同，可以通过 @[`AzureChatOpenAI`] 类访问。有关 Azure 聊天的文档，请参阅 [Azure Chat OpenAI 文档](/oss/integrations/chat/azure_chat_openai)。_
