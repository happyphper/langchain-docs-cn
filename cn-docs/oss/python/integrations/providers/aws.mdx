...
在 `langchain_community` 包中，通过 `boto3` 可选依赖项，还提供了一些社区集成。
...
查看[使用示例](/oss/integrations/llms/amazon_api_gateway)。
...
查看[使用示例](/oss/integrations/llms/sagemaker)。
...
查看[使用示例](/oss/integrations/text_embedding/sagemaker-endpoint)。
```python
...
查看 [S3DirectoryLoader 的使用示例](/oss/integrations/document_loaders/aws_s3_directory)。

查看 [S3FileLoader 的使用示例](/oss/integrations/document_loaders/aws_s3_file)。
...
查看[使用示例](/oss/integrations/document_loaders/amazon_textract)。
...
查看[使用示例](/oss/integrations/document_loaders/athena)。
...
查看[使用示例](/oss/integrations/document_loaders/glue_catalog)。
...
查看[使用示例](/oss/integrations/vectorstores/opensearch#using-aos-amazon-opensearch-service)。
...
查看[详细配置说明](/oss/integrations/vectorstores/documentdb)。
...
查看[使用示例](/oss/integrations/vectorstores/documentdb)。
...
```
查看[使用示例](/oss/integrations/vectorstores/memorydb)。
...
查看[使用示例](/oss/integrations/retrievers/amazon_kendra_retriever)。
...
查看[使用示例](/oss/integrations/retrievers/bedrock)。
...
查看[使用示例](/oss/integrations/tools/awslambda)。
...
查看[使用示例](/oss/integrations/graphs/amazon_neptune_open_cypher)。
...
查看[使用示例](/oss/integrations/callbacks/sagemaker_tracking)。
