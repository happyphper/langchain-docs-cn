...
有关访问托管在 [Azure 机器学习](https://azure.microsoft.com/en-us/products/machine-learning/) 上的聊天模型，请参阅[此处](/oss/integrations/chat/azureml_chat_endpoint)的文档。
...
查看 [Azure Blob 存储加载器的使用示例](/oss/integrations/document_loaders/azure_blob_storage)。
...
由于 Azure Database for PostgreSQL 是开源的 Postgres，您可以使用 [LangChain 的 Postgres 支持](/oss/integrations/vectorstores/pgvector/) 连接到 Azure Database for PostgreSQL。
