...
---
这将帮助您开始使用本地文件系统 [键值存储](/oss/integrations/stores)。有关 `LocalFileStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/langchain/storage/langchain.storage.file_system.LocalFileStore.html)。
