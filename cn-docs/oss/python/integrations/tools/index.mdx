...
| [Parallel 搜索](/oss/integrations/tools/parallel_search) | 付费 | URL、标题、摘录 |
| [SearchApi](/oss/integrations/tools/searchapi) | 注册时 100 次免费搜索 | URL、摘要、标题、搜索排名、网站链接、作者 |
...
| [Gmail 工具包](/oss/integrations/tools/google_gmail) | 免费，每秒每用户配额单位限制为 250 |
| [Infobip 工具](/oss/integrations/tools/infobip) | 免费试用，之后可变定价 |
| [Jira 工具包](/oss/integrations/tools/jira) | 免费，有[速率限制](https://developer.atlassian.com/cloud/jira/platform/rate-limiting/) |
...
| [Twilio 工具](/oss/integrations/tools/twilio) | 免费试用，之后采用[按量付费定价](https://www.twilio.com/en-us/pricing) |
...
| 工具/工具包 | 定价 | 支持与浏览器交互 |
|-------------|---------|---------------------------------------|
| [AgentQL 工具包](/oss/integrations/tools/agentql) | 免费试用，之后采用按量付费和固定费率计划 | ✅ |
| [Hyperbrowser 浏览器代理工具](/oss/integrations/tools/hyperbrowser_browser_agent_tools) | 免费试用，之后采用固定费率计划和预付费额度 | ✅ |
| [Hyperbrowser 网页抓取工具](/oss/integrations/tools/hyperbrowser_web_scraping_tools) | 免费试用，之后采用固定费率计划和预付费额度 | ❌ |
| [MultiOn 工具包](/oss/integrations/tools/multion) | 每天 40 次免费请求 | ✅ |
| [Oxylabs 网页抓取 API](/oss/integrations/tools/oxylabs) | 免费试用，之后采用固定费率计划和预付费额度 | ❌ |
...
| 工具/工具包 | 允许的操作 |
|-------------|-------------------|
| [Cassandra 数据库工具包](/oss/integrations/tools/cassandra_database) | SELECT 和模式自省 |
