...
<img
    ...
    alt="LangSmith UI 界面显示一个名为 ChatOpenAI 的 LLM 调用追踪，包含系统输入、用户输入和 AI 输出。"
/>
...
<img
    ...
    alt="LangSmith UI 显示名为 rag 的整个应用程序的追踪记录，包含输入和输出。"
/>
...
记录追踪记录后，使用 **[Polly](/langsmith/polly)** 对其进行分析，并获得关于应用程序性能的 AI 驱动洞察。
</Callout>
