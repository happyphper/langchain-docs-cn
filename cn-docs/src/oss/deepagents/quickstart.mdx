...
<Note>
    深度智能体需要支持[工具调用](/oss/concepts/tool-calling)的模型。有关如何配置模型，请参阅[自定义](/oss/deepagents/customization#model)。
</Note>
...
-   **定制你的智能体**：了解[定制选项](/oss/deepagents/customization)，包括自定义系统提示、工具和子智能体。
