...
<Tip>
**点击[此处](/oss/integrations/chat/google_generative_ai)查看 `@langchain/google-genai` 特定的集成文档**
</Tip>
...
<Tip>
**由于 Gemma 是一个开源模型，它也可能在其他平台上可用**，包括 [Ollama](/oss/integrations/chat/ollama/)。
</Tip>
