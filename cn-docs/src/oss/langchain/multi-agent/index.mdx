...
<Tip>
多智能体设计的核心是**[上下文工程](/oss/langchain/context-engineering)**——决定每个智能体能看到什么信息。系统的质量取决于能否确保每个智能体都能访问其任务所需的正确数据。
</Tip>
...
<Tip>
    你可以混合使用模式！例如，一个**子智能体**架构可以调用那些能触发自定义工作流或路由器智能体的工具。子智能体甚至可以使用**技能**模式来按需加载上下文。可能性是无限的！
</Tip>
