...
本指南提供了快速入门 (MODULE_NAME) [聊天模型](/oss/langchain/models) 的概述。有关 Chat(MODULE_NAME) 所有功能、参数和配置的详细列表，请参阅 [Chat(MODULE_NAME) API 参考](https://python.langchain.com/api_reference/(MODULE_NAME)/chat_models/langchain_(MODULE_NAME).chat_models.Chat(MODULE_NAME).html)。
...
| [工具调用](/oss/langchain/tools) | [结构化输出](/oss/langchain/structured-output/) | [图像输入](/oss/langchain/messages#multimodal) | [音频输入](/oss/langchain/messages#multimodal) | [视频输入](/oss/langchain/messages#multimodal) | [Token 级流式传输](/oss/langchain/streaming/) | 原生异步 | [Token 使用量](/oss/langchain/models#token-usage) | [Logprobs](/oss/langchain/models#log-probabilities) |
| :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅/❌ | ✅/❌ | ✅/❌ | ✅/❌ | ✅/❌ | ✅/❌ | ✅/❌ | ✅/❌ | ✅❌ |
