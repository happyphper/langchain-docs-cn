...
---
这将帮助您开始使用 FeatherlessAi [聊天模型](/oss/langchain/models)。有关 ChatFeatherlessAi 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/__package_name_short_snake__/chat_models/__module_name__.chat_models.ChatFeatherlessAi.html)。
