...
本文将帮助您开始使用 vLLM [聊天模型](/oss/langchain/models)，它利用了 `langchain-openai` 包。有关 @[`ChatOpenAI`] 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/openai/chat_models/langchain_openai.chat_models.base.ChatOpenAI.html)。
