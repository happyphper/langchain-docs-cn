...
此示例展示了如何使用 AI21SemanticTextSplitter 根据语义将文本分割成块。
...
此示例展示了如何使用 AI21SemanticTextSplitter 根据语义将文本分割成块，然后根据 `chunk_size` 合并这些块。
...
此示例展示了如何使用 AI21SemanticTextSplitter 根据语义将文本分割成文档。元数据将包含每个文档的类型。
...
此示例展示了如何使用 AI21SemanticTextSplitter 从文本创建文档，并为每个文档添加自定义元数据。
...
此示例展示了如何使用 AI21SemanticTextSplitter 根据语义将文本分割成文档。元数据将包含每个文档的起始索引。
**请注意**，起始索引提供的是块顺序的指示，而不是每个块的实际起始索引。
...
此示例展示了如何使用 AI21SemanticTextSplitter 根据语义将文档列表分割成块。
