...
title: Arcee
---
>[Arcee](https://www.arcee.ai/about/about-us) 致力于开发 SLMs——即小型、专业化、安全且可扩展的语言模型。

本笔记本演示了如何使用 `ArceeRetriever` 类来为 Arcee 的 `领域自适应语言模型` (`DALMs`) 检索相关文档。
...
您可以通过提供查询来从已上传的上下文中检索相关文档。示例如下：
