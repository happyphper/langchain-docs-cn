...
title: Chaindesk
---
>[Chaindesk 平台](https://docs.chaindesk.ai/introduction) 能够将来自任何地方的数据（数据源：文本、PDF、Word、PowerPoint、Excel、Notion、Airtable、Google Sheets 等）汇集到数据存储（包含多个数据源的容器）中。
...
retriever = ChaindeskRetriever(
    ...
    # api_key="CHAINDESK_API_KEY", # 可选，如果数据存储是公开的
    # top_k=10 # 可选
)
```
