...
| 工具/工具包 | 免费/付费 | 返回数据 |
|-------------|-----------|-------------|
| [Bing 搜索](/oss/integrations/tools/bing_search) | 付费 | URL、摘要、标题 |
| [Brave 搜索](/oss/integrations/tools/brave_search) | 免费 | URL、摘要、标题 |
| [DuckDuckgo 搜索](/oss/integrations/tools/ddg) | 免费 | URL、摘要、标题 |
| [Exa 搜索](/oss/integrations/tools/exa_search) | 每月 1000 次免费搜索 | URL、作者、标题、发布日期 |
| [Google 搜索](/oss/integrations/tools/google_search) | 付费 | URL、摘要、标题 |
| [Google Serper](/oss/integrations/tools/google_serper) | 免费 | URL、摘要、标题、搜索排名、网站链接 |
| [Jina 搜索](/oss/integrations/tools/jina_search) | 100 万响应令牌免费 | URL、摘要、标题、页面内容 |
| [Mojeek 搜索](/oss/integrations/tools/mojeek_search) | 付费 | URL、摘要、标题 |
| [并行搜索](/oss/integrations/tools/parallel_search) | 付费 | URL、标题、摘录 |
| [SearchApi](/oss/integrations/tools/searchapi) | 注册时提供 100 次免费搜索 | URL、摘要、标题、搜索排名、网站链接、作者 |
| [SearxNG 搜索](/oss/integrations/tools/searx_search) | 免费 | URL、摘要、标题、类别 |
| [SerpApi](/oss/integrations/tools/serpapi) | 每月 250 次免费搜索 | 答案 |
| [Tavily 搜索](/oss/integrations/tools/tavily_search) | 每月 1000 次免费搜索 | URL、内容、标题、图片、答案 |
| [You.com 搜索](/oss/integrations/tools/you) | 免费 60 天 | URL、标题、页面内容 |
...
| [Azure 容器应用动态会话](/oss/integrations/tools/azure_dynamic_sessions) | Python | 1 小时 | ✅ | 文本、图像 | ❌ |
| [Bearly 代码解释器](/oss/integrations/tools/bearly) | Python | 执行时重置 | ✅ | 文本 | ❌ |
| [Riza 代码解释器](/oss/integrations/tools/riza) | Python、JavaScript、PHP、Ruby | 执行时重置 | ✅ | 文本 | ✅ |
...
| 工具/工具包 | 定价 |
|-------------|---------|
| [GitHub 工具包](/oss/integrations/tools/github) | 免费 |
| [GitLab 工具包](/oss/integrations/tools/gitlab) | 个人项目免费 |
| [Gmail 工具包](/oss/integrations/tools/google_gmail) | 免费，但限制为每秒每用户 250 配额单位 |
| [Infobip 工具](/oss/integrations/tools/infobip) | 免费试用，之后采用可变定价 |
| [Jira 工具包](/oss/integrations/tools/jira) | 免费，但有[速率限制](https://developer.atlassian.com/cloud/jira/platform/rate-limiting/) |
| [Office365 工具包](/oss/integrations/tools/office365) | 使用 Office365 免费，包含[速率限制](https://learn.microsoft.com/en-us/graph/throttling-limits) |
| [Slack 工具包](/oss/integrations/tools/slack) | 免费 |
| [Twilio 工具](/oss/integrations/tools/twilio) | 免费试用，之后采用[按使用量付费定价](https://www.twilio.com/en-us/pricing) |
...
| 工具/工具包 | 定价 | 支持与浏览器交互 |
|-------------|---------|---------------------------------------|
| [AgentQL 工具包](/oss/integrations/tools/agentql) | 免费试用，之后提供按量付费和固定费率方案 | ✅ |
| [Amazon Bedrock AgentCore 浏览器](/oss/python/integrations/tools/bedrock_agentcore_browser) | 按使用量付费 (AWS) | ✅ |
| [Hyperbrowser 浏览器智能体工具](/oss/integrations/tools/hyperbrowser_browser_agent_tools) | 免费试用，之后提供固定费率方案和预付费额度 | ✅ |
| [Hyperbrowser 网页抓取工具](/oss/integrations/tools/hyperbrowser_web_scraping_tools) | 免费试用，之后提供固定费率方案和预付费额度 | ❌ |
| [MultiOn 工具包](/oss/integrations/tools/multion) | 每天 40 次免费请求 | ✅ |
| [Oxylabs 网页抓取 API](/oss/integrations/tools/oxylabs) | 免费试用，之后提供固定费率方案和预付费额度 | ❌ |
| [PlayWright 浏览器工具包](/oss/integrations/tools/playwright) | 免费 | ✅ |
| [Requests 工具包](/oss/integrations/tools/requests) | 免费 | ❌ |
...
| 工具/工具包 | 允许的操作 |
|-------------|-------------------|
| [Cassandra 数据库工具包](/oss/integrations/tools/cassandra_database) | SELECT 和模式内省 |
| [MCP 工具箱](/oss/integrations/tools/mcp_toolbox) | 任何 SQL 操作 |
| [SQLDatabase 工具包](/oss/integrations/tools/sql_database) | 任何 SQL 操作 |
| [Spark SQL 工具包](/oss/integrations/tools/spark_sql) | 任何 SQL 操作 |
| [Drasi 工具包](/oss/integrations/tools/drasi) | 实时数据库变更检测 |
...
| 工具/工具包 | 定价 | 功能 |
|-------------|---------|--------------|
| [GOAT](/oss/integrations/tools/goat) | 免费 | 创建和接收付款、购买实体商品、进行投资等。 |
| [Privy](/oss/integrations/tools/privy) | 免费 | 创建具有可配置权限的钱包，并快速执行交易。 |
