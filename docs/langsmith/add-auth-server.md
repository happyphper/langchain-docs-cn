...
你将保留相同的 <a href="https://reference.langchain.com/python/langsmith/deployment/sdk/#langgraph_sdk.auth.Auth" target="_blank" rel="noreferrer" class="link"><code>Auth</code></a> 对象和[资源级访问控制](/langsmith/auth#single-owner-resources)，但将身份验证升级为使用 Supabase 作为你的身份提供者。虽然本教程使用了 Supabase，但这些概念适用于任何 OAuth2 提供者。你将学习如何：
...
在之前的教程中，你使用 <a href="https://reference.langchain.com/python/langsmith/deployment/sdk/#langgraph_sdk.auth.Auth" target="_blank" rel="noreferrer" class="link"><code>Auth</code></a> 对象来[验证硬编码令牌](/langsmith/set-up-custom-auth)和[添加资源所有权](/langsmith/resource-auth)。

现在，你将升级你的身份验证，以验证来自 Supabase 的真实 JWT 令牌。主要的更改都将发生在 <a href="https://reference.langchain.com/python/langsmith/deployment/sdk/#langgraph_sdk.auth.Auth.authenticate" target="_blank" rel="noreferrer" class="link"><code>@auth.authenticate</code></a> 装饰的函数中：
...
3.  阅读 <a href="https://reference.langchain.com/python/langsmith/deployment/sdk/#langgraph_sdk.auth.Auth" target="_blank" rel="noreferrer" class="link">参考文档</a> 后，进一步自定义你的处理程序和设置。
