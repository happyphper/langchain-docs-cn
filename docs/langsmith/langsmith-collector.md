...
<strong>此配置需要对给定命名空间中的 Pod 拥有 'get'、'list' 和 'watch' 权限。</strong>
...
<strong>此配置需要对给定命名空间中的 Pod、服务和端点拥有 'get'、'list' 和 'watch' 权限。</strong>
...
<strong>OTel Collector 也支持直接导出到 [Datadog](https://docs.datadoghq.com/opentelemetry/setup/collector_exporter) 端点。</strong>
