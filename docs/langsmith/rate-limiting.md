...
更多信息请参阅 `langchain` 的 <a href="https://reference.langchain.com/python/langchain_core/language_models/#langchain_core.language_models.BaseChatModel.with_retry" target="_blank" rel="noreferrer" class="link">Python</a> 和 [JS](https://v03.api.js.langchain.com/classes/_langchain_core.language_models_chat_models.BaseChatModel.html#withRetry) API 参考。
