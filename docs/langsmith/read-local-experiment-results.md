...
本指南向您展示如何遍历和处理来自 <a href="https://reference.langchain.com/python/langsmith/observability/sdk/client/#langsmith.client.Client.evaluate" target="_blank" rel="noreferrer" class="link"><code>Client.evaluate()</code></a> 返回的 <a href="https://reference.langchain.com/python/langsmith/observability/sdk/evaluation/#langsmith.evaluation._runner.ExperimentResults" target="_blank" rel="noreferrer" class="link"><code>ExperimentResults</code></a> 对象的[实验](/langsmith/evaluation-concepts#experiment)结果。

<Note>

本页重点介绍以编程方式处理结果，同时仍将它们上传到 LangSmith。

如果您想在本地运行评估而<strong>不</strong>将任何内容记录到 LangSmith（用于快速测试或验证），请参考[在本地运行评估](/langsmith/local)，它使用 `upload_results=False`。

</Note>

## 遍历评估结果

<a href="https://reference.langchain.com/python/langsmith/observability/sdk/client/#langsmith.client.Client.evaluate" target="_blank" rel="noreferrer" class="link"><code>evaluate()</code></a> 函数返回一个 <a href="https://reference.langchain.com/python/langsmith/observability/sdk/evaluation/#langsmith.evaluation._runner.ExperimentResults" target="_blank" rel="noreferrer" class="link"><code>ExperimentResults</code></a> 对象，您可以对其进行遍历。`blocking` 参数控制结果何时可用：
