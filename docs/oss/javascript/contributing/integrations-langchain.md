...
- [**工具/工具包**](/oss/javascript/integrations/tools)：支持智能体（Agent）能力
- [**检索器**](/oss/javascript/integrations/retrievers)：RAG 应用程序的核心
- [**嵌入模型**](/oss/javascript/integrations/text_embedding)：向量操作的基础
- [**向量存储**](/oss/javascript/integrations/vectorstores)：语义搜索的关键

**不建议集成这些 ❌**：
- **LLMs（文本补全模型）**：已弃用，建议使用[聊天模型](/oss/javascript/integrations/chat)
...
如果适用，请为您的集成实现 LangChain [标准测试](/oss/javascript/contributing/standard-tests-langchain)套件的支持，并成功运行它们。
...
（可选）与 LangChain 团队合作进行[联合营销](/oss/javascript/contributing/comarketing)。
