...
以下是两个关于如何在 LangChain [LLMs](/oss/javascript/langchain/models) 或 [聊天模型](/oss/javascript/langchain/models) 中使用 `TrubricsCallbackHandler` 的示例。我们将使用 OpenAI 模型，因此请在此处设置您的 `OPENAI_API_KEY`：
