...
有关可用功能的详细信息，请访问 [`ChatOpenAI` 文档](/oss/integrations/chat/openai/)，或前往 <a href="https://reference.langchain.com/javascript/classes/_langchain_openai.AzureChatOpenAI.html" target="_blank" rel="noreferrer" class="link"><code>AzureChatOpenAI</code></a> API 参考。
