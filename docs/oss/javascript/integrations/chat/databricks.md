...
本指南提供了快速入门 Databricks [聊天模型](/oss/javascript/langchain/models) 的概述。有关 ChatDatabricks 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.databricks.ChatDatabricks.html)。
...
有关如何在链中使用 UC 函数，请参阅 [Databricks Unity Catalog](/oss/javascript/integrations/tools/databricks)。
