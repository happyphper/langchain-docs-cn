...
title: ChatEverlyAI
---
>[EverlyAI](https://everlyai.xyz) 允许您在云端大规模运行您的机器学习模型。它还提供了对[多个大语言模型](https://everlyai.xyz)的 API 访问。

本笔记本演示了如何使用 `langchain.chat_models.ChatEverlyAI` 来连接 [EverlyAI 托管端点](https://everlyai.xyz/)。
...
# 让我们尝试一下 EverlyAI 托管端点提供的 LLAMA 模型
