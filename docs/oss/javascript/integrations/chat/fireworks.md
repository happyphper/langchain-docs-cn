...
本指南将帮助您开始使用 `ChatFireworks` [聊天模型](/oss/javascript/langchain/models)。有关 `ChatFireworks` 所有功能和配置的详细文档，请前往 [API 参考](https://api.js.langchain.com/classes/langchain_community_chat_models_fireworks.ChatFireworks.html)。
