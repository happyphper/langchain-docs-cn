...
本页面将帮助您开始使用 GreenNode Serverless AI [聊天模型](/oss/javascript/langchain/models)。有关 ChatGreenNode 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/greennode/chat_models/langchain_greennode.chat_models.ChatGreenNode.html)。
