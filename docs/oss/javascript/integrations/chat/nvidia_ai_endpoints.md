...
title: ChatNVIDIA
---
这将帮助您开始使用 NVIDIA [聊天模型](/oss/javascript/langchain/models)。有关 `ChatNVIDIA` 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/nvidia_ai_endpoints/chat_models/langchain_nvidia_ai_endpoints.chat_models.ChatNVIDIA.html)。
...
有关更多示例，请参阅 [如何使用聊天模型调用工具](/oss/javascript/langchain/tools)。
