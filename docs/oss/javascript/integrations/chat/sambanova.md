...
title: ChatSambaNova
---
这将帮助您开始使用 SambaNova [聊天模型](/oss/javascript/langchain/models/)。有关 `ChatSambaNova` 所有功能和配置的详细文档，请参阅 [API 参考](https://docs.sambanova.ai/cloud/docs/get-started/overview)。
