...
本指南提供了使用 Seekr [聊天模型](/oss/javascript/langchain/models) 的快速入门概览。有关 `ChatSeekrFlow` 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.seekrflow.ChatSeekrFlow.html)。
