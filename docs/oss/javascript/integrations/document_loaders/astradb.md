...
Astra DB 文档加载器返回从 Astra DB 集合中读取的 LangChain <a href="https://reference.langchain.com/javascript/classes/_langchain_core.documents.Document.html" target="_blank" rel="noreferrer" class="link"><code>Document</code></a> 对象列表。
