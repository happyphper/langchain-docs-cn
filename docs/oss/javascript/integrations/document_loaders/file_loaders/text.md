...
本笔记本提供了快速入门 `TextLoader` [文档加载器](/oss/javascript/integrations/document_loaders) 的概述。有关 `TextLoader` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain.document_loaders_fs_text.TextLoader.html)。
