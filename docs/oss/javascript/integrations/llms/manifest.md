...
关于 `manifest` 的更多详细信息，以及如何像本示例中那样将其与本地 Hugging Face 模型一起使用，请参阅 [github.com/HazyResearch/manifest](https://github.com/HazyResearch/manifest)。

另一个 [将 Manifest 与 LangChain 结合使用](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html) 的示例。
