...
查看[使用示例](/oss/javascript/integrations/vectorstores/couchbase)。
...
CouchbaseSemanticCache 需要定义一个搜索索引才能工作。请查看[使用示例](/oss/javascript/integrations/vectorstores/couchbase)了解如何设置索引。
