...
title: Diffbot
---
> [Diffbot](https://docs.diffbot.com/docs) 是一套基于机器学习的产品，可以轻松地构建和集成网络数据。
...
Diffbot 的 [Extract API](https://docs.diffbot.com/reference/extract-introduction) 是一项用于从网页中构建和规范化数据的服务。
