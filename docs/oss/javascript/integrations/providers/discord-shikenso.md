...
以下代码片段展示了如何在 Discord 中读取和发送消息。更多详细信息，请参阅 [Discord 工具文档](/oss/javascript/integrations/tools/discord)。
...
`DiscordToolkit` 将多个与 Discord 相关的工具分组到一个统一的接口中。使用示例请参阅 [Discord 工具包文档](/oss/javascript/integrations/tools/discord)。
