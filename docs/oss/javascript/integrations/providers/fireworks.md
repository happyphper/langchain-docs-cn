...
查看[使用示例](/oss/javascript/integrations/chat/fireworks)。
...
查看[使用示例](/oss/javascript/integrations/llms/fireworks)。
...
查看[使用示例](/oss/javascript/integrations/text_embedding/fireworks)。
