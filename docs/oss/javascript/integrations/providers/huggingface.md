...
查看[使用示例](/oss/javascript/integrations/chat/huggingface)。
...
查看[使用示例](/oss/javascript/integrations/llms/huggingface_endpoint)。
...
查看[使用示例](/oss/javascript/integrations/llms/huggingface_pipelines)。
...
查看[使用示例](/oss/javascript/integrations/text_embedding/huggingfacehub)。
...
查看[使用示例](/oss/javascript/integrations/text_embedding/instruct_embeddings)。
...
查看[使用示例](/oss/javascript/integrations/text_embedding/bge_huggingface)。
...
> [Hugging Face Hub](https://huggingface.co/docs/hub/index) 拥有超过 75,000 个涵盖 100 多种语言的 [数据集](https://huggingface.co/docs/hub/index#datasets)，可用于 NLP、计算机视觉和音频领域的广泛任务。
...
查看[使用示例](/oss/javascript/integrations/document_loaders/hugging_face_dataset)。
...
>
> 此加载器与 `Hugging Face Models API` 交互，以获取和加载模型元数据及 README 文件。
> 该 API 允许您根据模型标签、作者等特定条件搜索和筛选模型。
...
查看[使用示例](/oss/javascript/integrations/document_loaders/image_captions)。
...
查看[使用示例](/oss/javascript/integrations/tools/huggingface_tools)。
