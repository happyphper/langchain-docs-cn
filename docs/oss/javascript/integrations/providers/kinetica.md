...
有关用法，请参阅 [Kinetica 语言转 SQL 聊天模型](/oss/javascript/integrations/chat/kinetica)。
...
有关用法，请参阅 [Kinetica 向量存储 API](/oss/javascript/integrations/vectorstores/kinetica)。
...
有关用法，请参阅 [Kinetica 文档加载器](/oss/javascript/integrations/document_loaders/kinetica)
...
有关用法，请参阅 [基于 Kinetica VectorStore 的检索器](/oss/javascript/integrations/retrievers/kinetica)
