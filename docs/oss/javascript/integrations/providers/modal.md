...
title: 模态框
---
本页介绍如何使用 Modal 生态系统运行 LangChain 自定义 LLM。
内容分为两部分：

1. Modal 安装与 Web 端点部署
2. 使用部署的 Web 端点与 `LLM` 包装类。
...
您的 Web 端点将在 `modal.run` 域名下获得一个持久 URL。

## 围绕 Modal Web 端点的 LLM 包装类

`Modal` LLM 包装类将接受您部署的 Web 端点的 URL。
