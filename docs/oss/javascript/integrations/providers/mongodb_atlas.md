...
请参阅[详细配置说明](/oss/javascript/integrations/vectorstores/mongodb_atlas)。
...
请参阅[使用示例](/oss/javascript/integrations/vectorstores/mongodb_atlas)。
...
MongoDBAtlasSemanticCache 继承自 `MongoDBAtlasVectorSearch`，并且需要定义一个 Atlas 向量搜索索引才能工作。请查看[使用示例](/oss/javascript/integrations/vectorstores/mongodb_atlas)了解如何设置索引。
