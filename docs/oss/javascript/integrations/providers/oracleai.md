...
请查看[使用示例](/oss/javascript/integrations/document_loaders/oracleai)。
...
请查看[使用示例](/oss/javascript/integrations/text_embedding/oracleai)。
...
请查看[使用示例](/oss/javascript/integrations/tools/oracleai)。
...
请查看[使用示例](/oss/javascript/integrations/vectorstores/oracle)。
