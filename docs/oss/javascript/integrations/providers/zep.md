...
您还可以找到与 Zep 开源版兼容的 [检索器](/oss/javascript/integrations/retrievers/zep_memorystore) 和 [向量存储](/oss/javascript/integrations/vectorstores/zep) 示例。
...
查看 [使用示例](/oss/javascript/integrations/retrievers/zep_cloud_memorystore)。
...
查看 [使用示例](/oss/javascript/integrations/vectorstores/zep_cloud)。
