...
本文将帮助您开始使用 [AzionRetriever](/oss/javascript/langchain/retrieval)。有关 AzionRetriever 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/_langchain_community.retrievers_azion_edgesql.AzionRetriever.html)。
