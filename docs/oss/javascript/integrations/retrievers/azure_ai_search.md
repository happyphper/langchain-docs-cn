...
本指南将帮助您开始使用 Azure AI Search [检索器](/oss/javascript/langchain/retrieval)。有关 `AzureAISearchRetriever` 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.azure_ai_search.AzureAISearchRetriever.html)。
