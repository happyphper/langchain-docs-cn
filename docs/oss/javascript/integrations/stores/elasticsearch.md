...
---
这将帮助您开始使用 Elasticsearch [键值存储](/oss/javascript/integrations/stores)。有关 `ElasticsearchEmbeddingsCache` 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/elasticsearch/cache/langchain_elasticsearch.cache.ElasticsearchEmbeddingsCache.html)。
...
与其他 `ByteStore` 一样，您可以将 `ElasticsearchEmbeddingsCache` 实例用于 RAG 的[文档摄取中的持久化缓存](/oss/javascript/integrations/text_embedding#caching)。
