...
```text
我们强烈建议传入一个 `attention_mask`，因为您的 input_ids 可能被填充了。请参阅 https://huggingface.co/docs/transformers/troubleshooting#incorrect-output-when-padding-tokens-arent-masked。
```
