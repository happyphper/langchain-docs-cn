...
---
本文将帮助您开始使用 LangChain 的 CohereEmbeddings [嵌入模型](/oss/javascript/integrations/text_embedding)。有关 `CohereEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_cohere.CohereEmbeddings.html)。

## 概述

### 集成详情

| 类 | 包 | 本地 | [Python 支持](https://python.langchain.com/docs/integrations/text_embedding/cohere/) | 下载量 | 版本 |
| :--- | :--- | :---: | :---: |  :---: | :---: |
...
要访问 Cohere 的嵌入模型，您需要创建一个 Cohere 账户，获取 API 密钥，并安装 `@langchain/cohere` 集成包。
...
有关 CohereEmbeddings 所有功能和配置的详细文档，请前往 [API 参考](https://api.js.langchain.com/classes/langchain_cohere.CohereEmbeddings.html)。
