...
title: 梯度
---
`Gradient` 允许通过简单的 Web API 创建 <a href="https://reference.langchain.com/javascript/classes/_langchain_core.embeddings.Embeddings.html" target="_blank" rel="noreferrer" class="link"><code>Embeddings</code></a>，以及对 LLM 进行微调和获取补全结果。
