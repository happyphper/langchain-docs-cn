...
LangChain 通过 <a href="https://reference.langchain.com/javascript/classes/_langchain_core.embeddings.Embeddings.html" target="_blank" rel="noreferrer" class="link">Embeddings</a> 接口为文本嵌入模型（例如 OpenAI、Cohere、Hugging Face）提供了一个标准接口。
