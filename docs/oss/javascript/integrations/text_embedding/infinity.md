...
title: Infinity
---
`Infinity` 允许使用 MIT 许可的 Embedding Server 来创建 <a href="https://reference.langchain.com/javascript/classes/_langchain_core.embeddings.Embeddings.html" target="_blank" rel="noreferrer" class="link"><code>Embeddings</code></a>。
