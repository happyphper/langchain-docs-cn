...
| 提供商 | 包 |
|:--------:|:-------:|
| [SambaNova](/oss/javascript/integrations/providers/sambanova/) | [langchain-sambanova](/oss/javascript/integrations/providers/sambanova/) |
...
嵌入模型通常用于检索增强生成（RAG）流程中，既用于索引数据，也用于后续检索。更详细的说明，请参阅我们的 [RAG 教程](/oss/javascript/langchain/rag)。
