...
本指南提供了快速入门 LinkupSearchTool [工具](/oss/javascript/langchain/tools) 的概览。有关 LinkupSearchTool 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/linkup/tools/linkup_langchain.search_tool.LinkupSearchTool.html)。
