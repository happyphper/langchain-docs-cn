...
title: Naver 搜索
---
Naver 搜索工具提供了一个简单的接口来搜索 Naver 并获取结果。
...
**搜索** : Naver 搜索工具提供了一个简单的接口来搜索 Naver 并获取结果。
...
Naver 搜索工具可以集成到 LangChain 智能体中，以执行更复杂的任务。下面我们演示如何设置一个可以搜索 Naver 获取当前信息的智能体。
