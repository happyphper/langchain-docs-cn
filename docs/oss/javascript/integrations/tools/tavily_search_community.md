...
本指南提供了快速入门 Tavily [工具](/oss/javascript/integrations/tools/) 的概览。关于 Tavily 工具的完整说明，您可以在 [API 参考](https://v03.api.js.langchain.com/classes/_langchain_community.tools_tavily_search.TavilySearchResults.html) 中找到更详细的文档。
