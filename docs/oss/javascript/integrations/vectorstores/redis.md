...
本指南提供了快速入门 Redis [向量存储](/oss/javascript/integrations/vectorstores) 的概述。有关 `RedisVectorStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_redis.RedisVectorStore.html)。
