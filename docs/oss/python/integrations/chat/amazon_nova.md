...
有关 <a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova/#langchain_amazon_nova.ChatAmazonNova" target="_blank" rel="noreferrer" class="link"><code>ChatAmazonNova</code></a> 所有功能和配置选项的详细文档，请参阅 <a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova/#langchain_amazon_nova.ChatAmazonNova" target="_blank" rel="noreferrer" class="link"><code>ChatAmazonNova</code></a> API 参考。
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| <a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova/#langchain_amazon_nova.ChatAmazonNova" target="_blank" rel="noreferrer" class="link"><code>ChatAmazonNova</code></a> | <a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova" target="_blank" rel="noreferrer" class="link"><code>langchain-amazon-nova</code></a> | beta | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-amazon-nova?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-amazon-nova?style=flat-square&label=%20) |
...
要访问 Amazon Nova 模型，您需要获取 API 凭据并安装 <a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova" target="_blank" rel="noreferrer" class="link"><code>langchain-amazon-nova</code></a> 集成包。
...
使用 Pydantic 模型或 LangChain <a href="https://reference.langchain.com/python/langchain/tools/#langchain.tools.tool" target="_blank" rel="noreferrer" class="link"><code>@tool</code></a> 将工具绑定到模型：
...
默认情况下，<a href="https://reference.langchain.com/python/langchain_core/language_models/#langchain_core.language_models.chat_models.BaseChatModel.bind_tools" target="_blank" rel="noreferrer" class="link"><code>BaseChatModel.bind_tools</code></a> 会验证模型是否支持工具调用。要禁用此验证：
...
<a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova/#langchain_amazon_nova.ChatAmazonNova" target="_blank" rel="noreferrer" class="link"><code>ChatAmazonNova</code></a> 客户端会自动禁用压缩，以避免潜在的解压缩问题。
...
有关 <a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova/#langchain_amazon_nova.ChatAmazonNova" target="_blank" rel="noreferrer" class="link"><code>ChatAmazonNova</code></a> 所有功能和配置的详细文档，请参阅 <a href="https://reference.langchain.com/python/integrations/langchain_amazon_nova/#langchain_amazon_nova.ChatAmazonNova" target="_blank" rel="noreferrer" class="link"><code>ChatAmazonNova</code></a> API 参考。
