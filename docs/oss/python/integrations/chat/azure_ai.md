...
---
本文将帮助你开始使用 AzureAIChatCompletionsModel [聊天模型](/oss/python/langchain/models)。有关 AzureAIChatCompletionsModel 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/azure_ai/chat_models/langchain_azure_ai.chat_models.AzureAIChatCompletionsModel.html)。
