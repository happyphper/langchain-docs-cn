...
title: ChatBaseten
---
本指南提供了快速入门 Baseten [聊天模型](/oss/python/langchain/models) 的概述。如需查看 ChatBaseten 所有功能、参数和配置的详细列表，请前往 [ChatBaseten API 参考](https://python.langchain.com/api_reference/baseten/chat_models/langchain_baseten.chat_models.ChatBaseten.html)。
