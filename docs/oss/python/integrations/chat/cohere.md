...
title: Cohere
---
本笔记本介绍了如何开始使用 [Cohere 聊天模型](https://cohere.com/chat)。

请前往 [API 参考](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.cohere.ChatCohere.html) 查看所有属性和方法的详细文档。

## 环境设置

该集成位于 `langchain-cohere` 包中。我们可以通过以下命令安装：
