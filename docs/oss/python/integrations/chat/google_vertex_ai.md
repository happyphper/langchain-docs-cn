...
<strong>Google Cloud VertexAI 与 Gemini API</strong>

Google Cloud VertexAI 集成与 [Google Gemini API](/oss/python/integrations/chat/google_generative_ai/) 是分开的。本页展示的是通过 Google Cloud Platform (GCP) 提供的企业版 Gemini。
...
有关所有功能和配置选项的详细文档，请前往 <a href="https://reference.langchain.com/python/integrations/langchain_google_vertexai/#langchain_google_vertexai.ChatVertexAI" target="_blank" rel="noreferrer" class="link"><code>ChatVertexAI</code></a> API 参考。
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| <a href="https://reference.langchain.com/python/integrations/langchain_google_vertexai/#langchain_google_vertexai.ChatVertexAI" target="_blank" rel="noreferrer" class="link"><code>ChatVertexAI</code></a> | <a href="https://reference.langchain.com/python/integrations/langchain_google_vertexai" target="_blank" rel="noreferrer" class="link"><code>langchain-google-vertexai</code></a> | beta | ✅ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-google-vertexai?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-google-vertexai?style=flat-square&label=%20) |
...
<strong>需要 `langchain-google-vertexai>=2.0.11`</strong>
...
<strong>需要 `langchain-google-vertexai>=2.0.25`</strong>
