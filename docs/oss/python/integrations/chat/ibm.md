...
---
这将帮助您开始使用 IBM watsonx.ai [聊天模型](/oss/python/langchain/models)。有关所有 `IBM watsonx.ai` 功能和配置的详细文档，请前往 [IBM watsonx.ai](https://api.js.langchain.com/modules/_langchain_community.chat_models_ibm.html)。
