...
---
这将帮助您开始使用 OCIModelDeployment [聊天模型](/oss/python/langchain/models)。有关 ChatOCIModelDeployment 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.oci_data_science.ChatOCIModelDeployment.html)。
