...
title: ChatOCIGenAI
---
本指南提供了 OCIGenAI [聊天模型](/oss/python/langchain/models) 的快速入门概览。有关 ChatOCIGenAI 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.oci_generative_ai.ChatOCIGenAI.html)。
