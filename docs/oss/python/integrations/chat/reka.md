...
注意，我们传入的是 `model`，而不是 `model_with_tools`。这是因为 <a href="https://reference.langchain.com/python/langchain/agents/#langchain.agents.create_agent" target="_blank" rel="noreferrer" class="link"><code>create_agent</code></a> 会在底层为我们调用 `.bind_tools`。
