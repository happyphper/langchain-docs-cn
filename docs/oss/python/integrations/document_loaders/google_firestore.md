...
本笔记本介绍了如何使用 [Firestore](https://cloud.google.com/firestore) 通过 `FirestoreLoader` 和 `FirestoreSaver` 来[保存、加载和删除 langchain 文档](/oss/python/integrations/document_loaders)。
