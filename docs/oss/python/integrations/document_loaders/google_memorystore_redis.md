...
本笔记本将介绍如何使用 [Memorystore for Redis](https://cloud.google.com/memorystore/docs/redis/memorystore-for-redis-overview) 通过 `MemorystoreDocumentLoader` 和 `MemorystoreDocumentSaver` 来 [保存、加载和删除 langchain 文档](/oss/python/integrations/document_loaders)。
