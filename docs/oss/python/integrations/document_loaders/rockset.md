...
假设 "sentence1" 字段是 `"This is the first sentence."`，"sentence2" 字段是 `"This is the second sentence."`，那么结果 <a href="https://reference.langchain.com/python/langchain_core/documents/#langchain_core.documents.base.Document" target="_blank" rel="noreferrer" class="link"><code>Document</code></a> 的 `page_content` 将是：
...
结果 <a href="https://reference.langchain.com/python/langchain_core/documents/#langchain_core.documents.base.Document" target="_blank" rel="noreferrer" class="link"><code>Document</code></a> 的 `page_content` 将是：
