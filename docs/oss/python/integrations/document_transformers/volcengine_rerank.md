...
title: 火山引擎重排序器
---
本笔记本展示了如何使用火山引擎（Volcengine）重排序器进行文档压缩和检索。[火山引擎](https://www.volcengine.com/)是 TikTok 母公司字节跳动开发的云服务平台。

火山引擎的重排序服务最多支持对 50 个文档进行重排序，最大 token 数为 4000。更多信息，请访问[此处](https://www.volcengine.com/docs/84313/1254474)和[此处](https://www.volcengine.com/docs/84313/1254605)。
