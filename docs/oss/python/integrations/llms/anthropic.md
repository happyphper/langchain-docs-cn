...
<strong>您当前正在查看的是关于使用 Anthropic 旧版 Claude 2 模型作为文本补全模型的文档页面。最新且最受欢迎的 Anthropic 模型是 [聊天补全模型](/oss/python/langchain/models)，而文本补全模型已被弃用。</strong>

您可能正在寻找 [这个页面](/oss/python/integrations/chat/anthropic/)。
