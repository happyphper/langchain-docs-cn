...
title: Pipeshift
---
这将帮助您开始使用 LangChain 与 Pipeshift 的补全模型（LLMs）。有关 `Pipeshift` 功能和配置选项的详细文档，请参阅 [API 参考](https://dashboard.pipeshift.com/docs)。
...
前往 [Pipeshift](https://dashboard.pipeshift.com) 注册 Pipeshift 并生成一个 API 密钥。完成后，设置 PIPESHIFT_API_KEY 环境变量：
...
如果您希望自动追踪您的模型调用，也可以通过取消注释以下代码来设置您的 [LangSmith](https://docs.langchain.com/langsmith/home) API 密钥：
