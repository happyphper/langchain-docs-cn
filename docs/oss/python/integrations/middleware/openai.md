...
**API 参考：** <a href="https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.OpenAIModerationMiddleware" target="_blank" rel="noreferrer" class="link"><code>OpenAIModerationMiddleware</code></a>
