...
你可以在标准的检索流程中使用 [`ExaSearchRetriever`](/oss/python/integrations/tools/exa_search#using-exasearchretriever)。你可以按如下方式导入它。
...
你可以按照 [Exa 工具调用文档](/oss/python/integrations/tools/exa_search#use-within-an-agent) 中的描述，将 Exa 用作智能体工具。
