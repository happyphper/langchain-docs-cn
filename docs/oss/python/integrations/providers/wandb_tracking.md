...
要了解更多关于 `WandbTracer` 的信息，请参考 [agent_with_wandb_tracing](/oss/python/integrations/providers/wandb_tracing) 笔记本或使用以下 [colab notebook](http://wandb.me/prompts-quickstart)。
