...
本文将帮助您开始使用 [AmazonKnowledgeBaseRetriever](/oss/python/langchain/retrieval)。有关 AmazonKnowledgeBaseRetriever 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_aws.AmazonKnowledgeBaseRetriever.html)。
