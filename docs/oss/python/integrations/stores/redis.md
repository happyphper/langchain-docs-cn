...
title: RedisStore
---
这将帮助您开始使用 Redis [键值存储](/oss/python/integrations/stores)。有关 `RedisStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/community/storage/langchain_community.storage.redis.RedisStore.html)。
