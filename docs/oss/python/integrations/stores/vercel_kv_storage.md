...
title: Vercel KV
---
本示例演示了如何使用 `VercelKVStore` <a href="https://reference.langchain.com/python/langsmith/deployment/remote_graph/" target="_blank" rel="noreferrer" class="link"><code>BaseStore</code></a> 集成来设置聊天历史存储。
