...
---
本文将帮助您开始使用 LangChain 集成 AzureOpenAI 嵌入模型。有关 `AzureOpenAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://python.langchain.com/api_reference/openai/embeddings/langchain_openai.embeddings.azure.AzureOpenAIEmbeddings.html)。
...
embeddings = AzureOpenAIEmbeddings(
    ...
    # dimensions: Optional[int] = None, # 对于新的 text-embedding-3 模型，可以指定维度
    # azure_endpoint="https://<your-endpoint>.openai.azure.com/", 如果未提供，将读取环境变量 AZURE_OPENAI_ENDPOINT
    # api_key=... # 可以直接提供 API 密钥。如果缺失，则读取环境变量 AZURE_OPENAI_API_KEY
