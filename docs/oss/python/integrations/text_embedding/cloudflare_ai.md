...
---
本文将帮助您开始使用 LangChain 结合 Cloudflare Workers AI [嵌入模型](/oss/python/integrations/text_embedding)。有关 `CloudflareWorkersAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_cloudflare.CloudflareWorkersAIEmbeddings.html)。
...
以下是一个示例 Worker，它使用 Workers AI 嵌入与 [Cloudflare Vectorize 向量存储](/oss/python/integrations/vectorstores/cloudflare_vectorize/)。
