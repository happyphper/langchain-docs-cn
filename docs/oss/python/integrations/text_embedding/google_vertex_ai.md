...
此集成已被弃用，并将在未来的版本中移除。请改用 [`GoogleGenerativeAIEmbeddings`](/oss/python/integrations/text_embedding/google_generative_ai)。查看完整的[发布说明和迁移指南](https://github.com/langchain-ai/langchain-google/discussions/1422)。
