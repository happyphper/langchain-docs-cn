...
---
本文将帮助您开始使用 LangChain 的 TogetherAIEmbeddings [嵌入模型](/oss/python/integrations/text_embedding)。有关 `TogetherAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain_community_embeddings_togetherai.TogetherAIEmbeddings.html)。
...
嵌入模型通常用于检索增强生成 (RAG) 流程中，既用于索引数据，也用于后续检索。更详细的说明，请参阅 [**学习**](/oss/python/learn/) 选项卡下的 RAG 教程。
