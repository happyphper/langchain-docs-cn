...
有关所有功能和配置选项的详细文档，请前往 <a href="https://reference.langchain.com/python/integrations/langchain_parallel/ParallelExtractTool" target="_blank" rel="noreferrer" class="link"><code>ParallelExtractTool</code></a> API 参考或 [Parallel 提取参考](https://docs.parallel.ai/api-reference/extract-beta/extract)。
