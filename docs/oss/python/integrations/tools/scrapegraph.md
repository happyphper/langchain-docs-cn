...
title: ScrapeGraph
---
本指南提供了快速入门 ScrapeGraph [工具](/oss/python/integrations/tools/) 的概述。有关所有 ScrapeGraph 功能和配置的详细文档，请参阅 [API 参考](https://python.langchain.com/docs/integrations/tools/scrapegraph)。

有关 ScrapeGraph AI 的更多信息：

- [ScrapeGraph AI 官网](https://scrapegraphai.com)
...
| SmartCrawlerTool | 通过爬虫从多个页面提取数据 | URL + 提示词 + 爬取选项 | JSON |
...
SmartCrawlerTool 允许您从网站爬取多个页面，并使用深度控制、页面限制和域名限制等高级爬取选项提取结构化数据。
