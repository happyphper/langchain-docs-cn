...
>Proxima 是阿里巴巴达摩院开发的高性能软件库。它允许您搜索向量的最近邻。与 Faiss 等类似的开源软件相比，Proxima 提供了更高的稳定性和性能。Proxima 允许您以高吞吐、低延迟的方式搜索相似的文本或图像嵌入。Hologres 与 Proxima 深度集成，以提供高性能的向量搜索服务。
