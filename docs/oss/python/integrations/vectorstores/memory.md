...
本指南提供了快速入门内存 [`向量存储`](/oss/python/integrations/vectorstores) 的概述。有关 `MemoryVectorStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://api.js.langchain.com/classes/langchain.vectorstores_memory.MemoryVectorStore.html)。
