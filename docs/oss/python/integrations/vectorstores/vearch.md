...
title: Vearch
---
>[Vearch](https://vearch.readthedocs.io) 是面向深度学习和 AI 应用的向量搜索基础设施。

## 环境设置

请按照[说明](https://vearch.readthedocs.io/en/latest/quick-start-guide.html#)进行操作。

你需要安装 `langchain-community` 包才能使用此集成，使用命令 `pip install -qU langchain-community`
